...
import 'package:longevity_ai/ui/screens/main_screen/widgets/button_colapse.dart';
import 'package:longevity_ai/ui/screens/main_screen/widgets/button_expand.dart';
...
class MainScreenState extends State<MainScreen>{
              ...
              Row(
                ...
                children: [
                  ...
                  RawMaterialButton(
                    ...
                    child: Image.asset(
                      widget._controller.isLeftBarExpanded ?
                        AppIcons.imageCollapse : AppIcons.imageExpand,
                        width: 32.r,
                        height: 32.r,
                    ),
                  )
  ...
  void changeState(){
    setState(() {
      widget._controller.isLeftBarExpanded = !widget._controller.isLeftBarExpanded;
    });
  }
}
...
class MainScreenController{
  ...
  final selectedItemProvider = SelectedItemNotifierProvider((ref) => SelectedItemNotifier(SelectedLeftBarItem.patientOverview));
...
typedef SelectedItemNotifierProvider = StateNotifierProvider<SelectedItemNotifier, SelectedLeftBarItem>;
