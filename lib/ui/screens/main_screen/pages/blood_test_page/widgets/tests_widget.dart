...
import 'package:longevity_ai/ui/screens/main_screen/pages/blood_test_page/widgets/parameter_graphics.dart';

class TestsWidget extends ConsumerWidget {
  TestsWidget({super.key, required List<Test> bloodTests})
      : controller = TestsWidgetController(bloodTests);
  final TestsWidgetController controller;
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final currentParameter = ref.watch(controller.currentParameterProvider);
    return Row(
      children: [
        Container(
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return BloodTestWidget(
                      test: controller.bloodTests[index],
...
class TestsWidgetController {
  ...
  final currentParameterProvider =
      CurrentParameterProvider((ref) => CurrentTestParameterNotifier(null));
...
typedef CurrentParameterProvider
    = StateNotifierProvider<CurrentTestParameterNotifier, TestParameter?>;
